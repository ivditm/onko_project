...
region_to_district = {
    ...
    'Ненецкий а.о.': 'СЕВЕРО-ЗАПАДНЫЙ ФО',
    'Архангельская обл.(б/а.о)': 'СЕВЕРО-ЗАПАДНЫЙ ФО',
    'Вологодская область': 'СЕВЕРО-ЗАПАДНЫЙ ФО',
    'Калининградская область': 'СЕВЕРО-ЗАПАДНЫЙ ФО',
    'г. Санкт-Петербург': 'СЕВЕРО-ЗАПАДНЫЙ ФО',
    ...
    'Респ. Кабардино-Балкария': 'СЕВЕРО-КАВКАЗСКИЙ ФО',
    'Респ. Северная Осетия': 'СЕВЕРО-КАВКАЗСКИЙ ФО',
    'Респ. Карачаево-Черкесия': 'СЕВЕРО-КАВКАЗСКИЙ ФО',
    'Республика Чечня': 'СЕВЕРО-КАВКАЗСКИЙ ФО',
    ...
    'Республика Удмуртия': 'ПРИВОЛЖСКИЙ ФО',
    'Республика Чувашия': 'ПРИВОЛЖСКИЙ ФО',
    'Ханты-Мансийский а.о.': 'УРАЛЬСКИЙ ФО',
    'Ямало-Ненецкий а.о.': 'УРАЛЬСКИЙ ФО',
    'Курганская область': 'УРАЛЬСКИЙ ФО',
    'Свердловская область': 'УРАЛЬСКИЙ ФО',
    'Тюменская обл.(б/а.о)': 'УРАЛЬСКИЙ ФО',
